		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 col-md-12">
				<div class="about-item position-relative mt-5 mt-lg-0">
					...
					<h2 class="mt-1 mb-3">Having <span class="text-color">5 years</span> of experience in services</h2>

					<p class="mb-4">We offer the best application to our clients with our system that can help users to make task easier. Our system
						will provide the best booking experience for the users.
					</p>

					<a href="service.html" class="btn btn-main">Booking<i class="ti-angle-right ml-2"></i></a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row ">
			...
			<div class="col-lg-4 col-md-6">
				<div class="card p-4 text-center border-0 mb-4 rounded-0">
					...
					<p class="mt-3 mb-4">Booking for future time can be made and booking can be canceled through system.</p>
				</div>
			</div>
			<div class="col-lg-4 col-md-6">
				<div class="card p-4 text-center border-0 mb-4 rounded-0 bg-black-50">
					<h3 class="mt-3 text-white">Permit System</h3>
					<p class="mt-3 mb-4 text-white">Permit will be given after booking has been made and become void after it has expired. Permit
