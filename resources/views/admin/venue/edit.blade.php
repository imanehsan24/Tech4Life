      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="flex m-2 p-2">
              <a href="{{ route('admin.venue.index') }}"
                  class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">View All Venues</a>
          </div>
          <div class="m-2 p-2 bg-slate-100 rounded">
              <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                  <form method="POST" action="{{ route('admin.venue.update', $venue->id) }}"
                      ...
                      <div class="sm:col-span-6">
                          ...
                          <div>
                              <img class="w-32 h-32" src="{{ Storage::url($venue->image) }}">
                          </div>
                          <div class="mt-1">
